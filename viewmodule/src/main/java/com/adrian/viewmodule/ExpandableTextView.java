...
public class ExpandableTextView extends TextView{
    ...
    private static final boolean EXPAND_SELF_ENABLE = true;
    ...
    private boolean mExpandSelfEnable = EXPAND_SELF_ENABLE;
    ...
    private void initAttr(Context context, AttributeSet attrs) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            }else if (attr == R.styleable.ExpandableTextView_etv_EnableExpandSelf) {
                mExpandSelfEnable = a.getBoolean(attr, EXPAND_SELF_ENABLE);
            }
        }
        a.recycle();
    }
